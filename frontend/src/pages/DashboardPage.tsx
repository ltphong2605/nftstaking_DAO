...
export default function DashboardPage() {
  ...
  const [rewardSymbolNFT, setRewardSymbolNFT] = useState('$COOLBEEZ')
  ...
  const handleFilter = async (e, val) => {
    if(val === 'nft') {
      ...
      if(bSuccess) {
        ...
        notifyError('You can not withdraw! Please stake NFTs.')
      }
    }
  }
  ...
  return (
    ...
    <DefaultPageTemplate bgGray > 
      <Row justify="center">
        <S.Image src='images/characters/Mascots V4 8.png'></S.Image>
      </Row>
