...
contract coolbeez is ERC721Enumerable, Ownable {
    ...
    uint256 public maxCollection = 3;
    uint256 public maxAirdropSupply = 500;
    ...
    uint256 public pubicPrice = 0.15 ether;

    mapping(address => bool) public whitelist;
    // Payment Addresses
    address constant wallet1 = 0x74DAf1a1c7B32e0D8d518CC576898888F9cCD646;
    address constant wallet2 = 0xAC7e548A7c87F2FFA4224396Bf91B32b32a03BF9;
    address constant wallet3 = 0x8642D41B248d97172c7F56023d66D3EEBB7E8475;
    ...
    */
    ...
    constructor() ERC721("coolbeez", "CB") {
        //setBaseURI(baseURI);
    }
    ...
    function freeMint() external onlyOwner {
        require(!paused,                                'Contract is paused.');
    ...
    function isFreeMint(bool _state) public onlyOwner {
        isFree = _state;
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        // wallet1 12.5%
        (bool wa1, ) = payable(wallet1).call{value: address(this).balance * 125 / 1000}("");
        require(wa1);
        // wallet2 10%
        (bool wa2, ) = payable(wallet2).call{value: address(this).balance * 100 / 1000 * 1000 / 875}("");
        require(wa2);
        // wallet3 10%
        (bool wa3, ) = payable(wallet3).call{value: address(this).balance * 100 / 1000 * 1000 / 775}("");
        require(wa3);
        // owner wallet
        (bool wa4, ) = payable(owner()).call{value: address(this).balance}("");
        require(wa4);
    }
